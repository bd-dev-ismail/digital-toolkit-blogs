...
export const Navbar = () => {
  ...
  const menu = (
    <>
      ...
      <li>
        <Link to="/all-blogs" className="text-white font-medium">
          All Blogs
        </Link>
      </li>
      <li>
        <Link to="/history" className="text-white font-medium">
          Reading History
        </Link>
      </li>
      <li>
          ...
          <div className="lg:hidden">
            ...
            {isMenuOpen && (
              <div className="absolute top-0 left-0 w-full">
                <div className="p-5 bg-purple-400 border rounded shadow-sm">
